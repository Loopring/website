            ...
            <ScrollToTop>
              <Switch>
                ...
                <Route path="/amm_mining_zh">
                  <Redirect to={{pathname: '/embed/amm_mining_11_zh.md'}} />
                </Route>

                <Route path="/amm_mining_en">
                  <Redirect to={{pathname: '/embed/amm_mining_11_en.md'}} />
                </Route>

                <Route path="/amm_top25_en">
                  <Redirect
                    to={{pathname: '/embed/L2 trade_top25_11_en.md'}}
                  />
                </Route>

                <Route path="/amm_top25_zh">
                  <Redirect
                    to={{pathname: '/embed/L2 trade_top25_11_zh.md'}}
                  />
                </Route>

                <Route path="/orderbook_mining_zh">
                  <Redirect
                    to={{pathname: '/embed/orderbook_mining_21_zh.md'}}
                  />
                </Route>

                <Route path="/orderbook_mining_en">
                  <Redirect
                    to={{pathname: '/embed/orderbook_mining_21_en.md'}}
                  />
                </Route>
